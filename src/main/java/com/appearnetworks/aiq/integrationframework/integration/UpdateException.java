 ...
 * <ul>
 * <li>{@link org.springframework.http.HttpStatus#FORBIDDEN} - violation of business rule, invalid attachment data or permission denied</li>
 * <li>{@link org.springframework.http.HttpStatus#NOT_FOUND} - unrecognized document type, or document not found (for attachments)</li>
